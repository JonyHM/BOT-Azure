...
class OrderDialog extends ComponentDialog {
  constructor(userState) {
    ...
    // Adicionando a ordem do diálogo: A ordem do nosso BOT será: 
    //NOME: string > TAMANHO: string(pode ser numero ou palavra que representa tamanho) 
    //> COBERTURA: string > QUANTIDADE: numero(apenas) > ENTREGA: Boolean(SIM OU NÃO) -> se sim, pedir endereço e informar taxa de entrega
    //> TIPO_DE_PAGAMENTO: OPÇÕES(CARTAO / DINHEIRO)
